...
struct LandingView: View {
            ...
            VStack(spacing: DSSpacing.l) {
                ...
                Button(action: {
                    ...
                    HStack(alignment: .top, spacing: DSSpacing.s) {
                        ...
                        Text("I have read and understand that Valtyde does not provide financial advice.")
                            .font(.system(size: 14, weight: .regular))
    ...
    private var disclaimerText: String {
        """
        Valtyde is provided for informational and educational purposes only and does not constitute financial, investment, legal, or tax advice.
        ...
        Valtyde does not make any representations or warranties regarding the accuracy, completeness, or reliability of any information or results produced. Past performance is not indicative of future results.
        ...
        By continuing, you agree that Valtyde, its creators, affiliates, and partners shall not be liable for any losses, damages, or claims arising from the use of this application.
        """
    }
